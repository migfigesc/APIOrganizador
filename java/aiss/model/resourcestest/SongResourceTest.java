package aiss.model.resourcestest;
...
public class SongResourceTest {
	...
	public void testGetSong() {
		...
		assertEquals("The name of the songs do not match", song1.getTitle(), s.getTitle());
	...
	public void testAddSong() {
		...
		Song song4 = new Song("Entre dos aguas","Paco de Lucia","Entre dos aguas","2021");
		Song added = sr.addSong(song4);
		
		assertNotNull("Error when adding the song", song4);
		assertEquals("The song's name has not been setted correctly", added.getTitle(), song4.getTitle());
		assertEquals("The song's album has not been setted correctly", added.getAlbum(), song4.getAlbum());
		assertEquals("The song's year has not been setted correctly", added.getYear(), song4.getYear());
	}
