...
public class IntervaloResourceTest {
	...
	public static void setUp() throws Exception {
		...
		intervalo = ivr.addIntervalo(new Intervalo());
		intervalo2 = ivr.addIntervalo(new Intervalo());
		intervalo3 = ivr.addIntervalo(new Intervalo());
	...
	public void testAddIntervalo() {
		...
		intervalo4 = ivr.addIntervalo(new Intervalo());
